# Webots-genetic_truck_controller-4.0.0
...
- Crossover method: BLX-alpha (generating 2 sons and selecting the most different one (euclidean distance) from the mother).
